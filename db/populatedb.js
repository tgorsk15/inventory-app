...
const createItems = `
    ...
    VALUES
        ('PRS SE Custom 24', 1, 1000, '../public/imgs/prs-se-custom-24.jpg'),
        ('PRS SE DGT', 2, 600, '../public/imgs/prs-se-dgt.jpg'),
        ('Ibanez Midnight', 3, 800, '../public/imgs/ibanez-midnight.jpg'),
        ('Gretsch Electromatic Classic', 1, 700, '../public/imgs/gretsch-electromatic-classic.jpg'),
        ('Les Paul 1959', 2, 1200, '../public/imgs/gibson-lespaul-1959.jpg'),
        ('Fender Mustang', 3, 650, '../public/imgs/fender-mustang'),
        ('Fender Kurt Cobain Jaguar', 1, 1800, '../public/imgs/fender-cobain-jaguar.jpg')
